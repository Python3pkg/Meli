...
class BasicMeliTests(unittest.TestCase):
    ...
    def test_categorie_not_found(self):
    ...
    def test_validate_product_wrong_category(self):
    ...
    def test_modify_item(self):
        ...
        Product = self.meli.put('items/MLB452876993', product_modify, access=True)
        self.assertTrue(Product)
